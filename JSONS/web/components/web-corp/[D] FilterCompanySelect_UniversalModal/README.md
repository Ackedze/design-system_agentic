# [D] FilterCompanySelect_UniversalModal — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web _ Corp Components / [D] FilterCompanySelect_UniversalModal**.
