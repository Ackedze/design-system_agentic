# CorporatePage — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web _ Corp Components / CorporatePage**.

The raw Figma catalog remains the source of truth:

`../Web _ Corp Components -- CorporatePage.json`
