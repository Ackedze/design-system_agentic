# ScenarioModel ! interruption — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web _ Corp Components / ScenarioModel ! interruption**.
