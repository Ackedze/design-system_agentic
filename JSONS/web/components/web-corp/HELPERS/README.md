# HELPERS — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Corp Components / HELPERS**.
...
- Сгенерировано: `2026-04-22T09:22:10.320Z`
- Компонентов: `15`
